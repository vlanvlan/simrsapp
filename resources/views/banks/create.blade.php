                ...
                <form action="{{ route('banks.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="instrument_type" name="instrument_type" required>
                            ...
                            <option value="current_account" {{ old('instrument_type') == 'current_account' ? 'selected' : '' }}>Current Account</option>
                            <option value="savings" {{ old('instrument_type') == 'savings' ? 'selected' : '' }}>Savings</option>
                            <option value="deposit" {{ old('instrument_type') == 'deposit' ? 'selected' : '' }}>Deposit</option>
                            <option value="bond" {{ old('instrument_type') == 'bond' ? 'selected' : '' }}>Bond</option>
                            <option value="money_market" {{ old('instrument_type') == 'money_market' ? 'selected' : '' }}>Money Market</option>
                        </select>
